...
const socials = [
  ...
  {
    file: 'assets/social-portfolio.svg',
    name: 'Portfolio',
    color: '#70A5FD',
  ...
  {
    file: 'assets/social-codersrank.svg',
    name: 'CodersRank',
    color: '#64C4A3',
...
socials.forEach(s => {
  ...
  <defs>
    <style>
      ...
      .text { fill: #a9b1d6; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 1px; }
